      ...
      <form className='form-inline my-2 my-lg-0'>
        ...
        <li className="nav-item nav-link dropdown">
          ...
          <div className="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <div className="dropdown-divider"></div>
            <Link className="dropdown-item" to="/draftclass/2030">2030</Link>
            <div className="dropdown-divider"></div>
            <Link className="dropdown-item" to="/draftclass/2031">2031</Link>
            <div className="dropdown-divider"></div>
            <Link className="dropdown-item" to="/draftclass/2032">2032</Link>
            <div className="dropdown-divider"></div>
            <Link className="dropdown-item" to="/draftclass/2033">2033</Link>
            <div className="dropdown-divider"></div>
            <Link className="dropdown-item" to="/draftclass/2034">2034</Link>
            <div className="dropdown-divider"></div>
            <Link className="dropdown-item" to="/draftclass/2035">2035</Link>
          </div>
        </li>
        ...
        <Link className='nav-item nav-link adminTab' id='adminTab' to='/admin'>Admin</Link>
      </form>
